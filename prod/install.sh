#!/usr/bin/env sh
# Minigrid Server installer for version 0.1.3
set -e
...
printf "========================================\n"
$CURL -L https://raw.githubusercontent.com/SEL-Columbia/minigrid-server/0.1.3/prod/docker-compose.yml > docker-compose.yml
$CURL -L https://raw.githubusercontent.com/SEL-Columbia/minigrid-server/0.1.3/prod/nginx.conf > nginx.conf
